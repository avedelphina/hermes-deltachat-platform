...
3. `register_rpc_tools()` registers Delta Chat-specific tools (`dc_rpc_spec`, `dc_chat_rpc_spec`, `dc_safe_rpc_call`, `dc_start_call`, `dc_end_call`, and optionally `dc_rpc_call`).
